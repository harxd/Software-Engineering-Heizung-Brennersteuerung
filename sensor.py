...
class TemperatureSensor:
    ...
    def __init__(self, initial_temp: float = 20.0):
        ...
        self.heating_rate = 0.05  # MUCH slower: Temperature increase per second when heating
        self.cooling_rate = 0.03  # MUCH slower: Temperature decrease per second when cooling
